...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox_1.lineEdit().setReadOnly(True)
        self.comboBox_1.lineEdit().setAlignment(QtCore.Qt.AlignCenter)
        self.comboBox_1.addItem("")
        self.comboBox_1.addItem("")
        self.comboBox_1.addItem("")
        for i in range(self.comboBox_1.count()):
            self.comboBox_1.setItemData(i, QtCore.Qt.AlignCenter, QtCore.Qt.TextAlignmentRole);
        ...
        self.comboBox_2.lineEdit().setReadOnly(True)
        self.comboBox_2.lineEdit().setAlignment(QtCore.Qt.AlignCenter)
        self.comboBox_2.addItem("")
        self.comboBox_2.addItem("")
        self.comboBox_2.addItem("")
        for i in range(self.comboBox_2.count()):
            self.comboBox_2.setItemData(i, QtCore.Qt.AlignCenter, QtCore.Qt.TextAlignmentRole);
        ...
        self.comboBox_3.lineEdit().setReadOnly(True)
        self.comboBox_3.lineEdit().setAlignment(QtCore.Qt.AlignCenter)
        self.comboBox_3.addItem("")
        self.comboBox_3.addItem("")
        self.comboBox_3.addItem("")
        for i in range(self.comboBox_3.count()):
            self.comboBox_3.setItemData(i, QtCore.Qt.AlignCenter, QtCore.Qt.TextAlignmentRole);
        ...
        self.comboBox_4.lineEdit().setReadOnly(True)
        self.comboBox_4.lineEdit().setAlignment(QtCore.Qt.AlignCenter)
        self.comboBox_4.addItem("")
        self.comboBox_4.addItem("")
        self.comboBox_4.addItem("")
        for i in range(self.comboBox_4.count()):
            self.comboBox_4.setItemData(i, QtCore.Qt.AlignCenter, QtCore.Qt.TextAlignmentRole);
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Instrument 4"))
